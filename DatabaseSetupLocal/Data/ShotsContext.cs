...
public class ShotsContext : DbContext
{
    protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
    {
        optionsBuilder.UseMySql(
            connectionString: @"server=localhost;database=dbsetuptest;uid=rkkrowicki;password=Lapis5Redstone9;",
            ServerVersion.AutoDetect(
                @"server=localhost;database=dbsetuptest;uid=rkkrowicki;password=Lapis5Redstone9;"));
    }
